...
export default function CazaVisionPage() {
  ...
  return (
    <>
      <Header title="Caza Vision" subtitle="Business Unit · PropTech / Vision AI" />
      ...
      <div className="px-8 py-6 space-y-6">
        ...
        <div>
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium border border-amber-500/30 bg-amber-500/10 text-amber-400">
            ...
            Scope: Caza Vision only · Dados isolados por BU
          </span>
        </div>
              ...
              <div className="border-t border-gray-800 pt-3 flex items-center justify-between">
                ...
                <span
                  className={`text-sm font-semibold tabular-nums ${
                    cashflow.overdueReceivables.length > 0 ? "text-red-400" : "text-emerald-400"
                  }`}
                >
                  {cashflow.overdueReceivables.length}
                </span>
              </div>
            </div>
          </div>
